...
namespace TLInteractive {
   ...
   class Grammar : public TL::Parser::Spirit::grammar<Grammar> {
      ...
      Grammar(TL::Parser::Parsers& parsers,
      ...
      class definition {
         ...
         TL::Parser::Spirit::rule<ScannerT> const& start() const {
            return system;
         }
         ...
         void postParseInput() {
            ...
            #warning need to do something about memory, but need to keep old demands around too
