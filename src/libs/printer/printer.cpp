...
class Printer : public TL::TypedValueBase
{
  ...
  void
  print(std::ostream& os, const TL::Tuple& c, TL::Interpreter& i) const;

  bool
  operator==(const Printer& rhs) const
  {
...
Data*
PrintVisitor::visitBinaryOpExpr(BinaryOpExpr* e, Data*)
{
...
/** @brief visitIsTypeExpr
  ...
  */
Data*
PrintVisitor::visitIsTypeExpr(SpecialOpsExpr* e, Data*)
{
...
Data*
PrintVisitor::visitBuildTupleExpr(BuildTupleExpr* e, Data*)
{
  m_os << '[';
...
/** @brief visitPairExpr
  ...
  */
Data*
PrintVisitor::visitPairExpr(PairExpr* e, Data*)
{
  e->lhs->visit(this, 0);
  m_os << " : ";
  e->rhs->visit(this, 0);
...
/** @brief visitIdentExpr
  ...
  */
Data*
PrintVisitor::visitIdentExpr(IdentExpr* e, Data*)
{
  m_os << "ident<" << e->id << ">";
  return 0;
}
...
/** @brief visitIfExpr
  ...
  */
Data*
PrintVisitor::visitIfExpr(IfExpr* e, Data*)
{
  m_os << "if ";
...
/** @brief visitIntegerExpr
  ...
  */
Data*
PrintVisitor::visitIntegerExpr(IntegerExpr* e, Data*)
{
  m_os << e->m_value;
  return 0;
}
...
/** @brief visitIsSpecialExpr
  ...
  */
Data*
PrintVisitor::visitIsSpecialExpr(SpecialOpsExpr* e, Data*)
{
  if (m_type == Printer::MAXIMAL)
  {
    m_os << '(';
...
/** @brief visitDimensionExpr
  ...
  */
Data*
PrintVisitor::visitDimensionExpr(DimensionExpr* e, Data*)
{
  m_os << "dim<" << e->value << ">";
  return 0;
}
...
/** @brief visitHashExpr
  ...
  */
Data*
PrintVisitor::visitHashExpr(HashExpr* e, Data*)
{
  if (m_type == Printer::MAXIMAL)
  {
    m_os << "(";
...
/** @brief visitConstantExpr
  ...
  */
Data*
PrintVisitor::visitConstantExpr(ConstantExpr* e, Data*)
{
  m_os << e->name << "<" << e->value << ">";
  return 0;
}
...
/** @brief visitBooleanExpr
  ...
  */
Data*
PrintVisitor::visitBooleanExpr(BooleanExpr* e, Data*)
{
  if (e->value)
  {
    m_os << "true";
...
/** @brief visitAtExpr
  ...
  */
Data*
PrintVisitor::visitAtExpr(AtExpr* e, Data*)
{
  if (m_type == Printer::MAXIMAL)
  {
    m_os << "(";
...
/** @brief visitConvertExpr
  ...
  */
Data*
PrintVisitor::visitConvertExpr(SpecialOpsExpr* e, Data*)
{
  if (m_type == Printer::MAXIMAL)
  {
    m_os << '(';
...
Data*
PrintVisitor::visitRangeExpr(RangeExpr* e, Data*)
{
  if (e->lhs)
  {
    e->lhs->visit(this, 0);
...
Data*
PrintVisitor::visitUnaryExpr(UnaryExpr* e, Data*)
{
  return 0;
}
